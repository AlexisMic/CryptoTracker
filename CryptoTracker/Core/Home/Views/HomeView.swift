...
struct HomeView: View {
    ...
    @State private var showPortfolio = false // right animation
    ...
    var body: some View {
        ZStack {
                ...
                if !showPortfolio {
                    ...
                    ZStack(alignment: .top) {
                        if vm.portfolioCoins.isEmpty && vm.searchText.isEmpty {
                            Text("Add coins to your Portfolio by pressing the + button!")
                                .font(.callout)
            ...
            .sheet(isPresented: $showSettingsView, content: {
                SettingsView(showThisSheet: $showSettingsView)
            })
        }
        .background(
            NavigationLink(
